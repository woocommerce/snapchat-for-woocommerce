...
/**
 * A higher-order component for wrapping the app shell on top of the Snapchat admin page.
...
const withAdminPageShell = createHigherOrderComponent(
	( Page ) => ( props ) => {
		return (
			// snap4woo-admin-page is for scoping particular styles to a GLA admin page.
			<div className="snap4woo-admin-page">
				<Page { ...props } />
			</div>
		);
	},

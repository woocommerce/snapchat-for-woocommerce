...
const TopBar = ( { title, backHref, helpButton, onBackButtonClick } ) => {
	return (
		<div className="snap4woostepper-top-bar">
			<Link
				className="components-button snap4woostepper-top-bar__back-button"
				href={ backHref }
				type="wc-admin"
			...
			<span className="snap4woostepper-top-bar__title">{ title }</span>
			{ helpButton }
		</div>
	);
};

...
if ( class_exists( Options::class ) && defined( 'E2E_CONTEXT' ) ) {
	Transients::set( TransientDefaults::PIXEL_SCRIPT, '<script>var x="https://sc-static.net/scevent.min.js";window.snaptr=function(){window.snaptr.queue.push(Array.from(arguments))},window.snaptr.queue=[];</script>' );
}

 ...
 *
 * @event sfw_ads_account_disconnect_button_click
 ...
 *
 * @fires sfw_ads_account_disconnect_button_click When the user clicks on the button to disconnect the Google Ads account.
 *
...
const DisconnectAccountButton = ( { onDisconnected = noop } ) => {
	...
	return (
		<AppButton
			...
			eventName="sfw_ads_account_disconnect_button_click"
			eventProps={ {
				step: '1', // @TODO: review
			} }
